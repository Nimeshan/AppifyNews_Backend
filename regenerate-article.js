...
async function regenerateArticle() {
  try {
    ...
    if (result.status === 200 && result.data.success) {
      ...
      console.log(`✅ Article content has been completely rewritten with SEO-optimized, NatWest-specific content!`);
      console.log(`✅ Meta tags have been removed from the content!`);
    } else {
